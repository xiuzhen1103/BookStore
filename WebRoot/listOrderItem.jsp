...
<div align="center" id="header">
 ...
 <br> <br />
 	 ...
 	 <table style="width:100%" width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
 	 	 <tr>
		      <td width="5%" height="37" align="center"><b>Order Item Id</b></td>
		      <td width="10%" height="37" align="center"><b>Price</b></td>
		      <td width="10%" height="37" align="center"><b>Quantity</b></td>
		      <td width="10%" height="37" align="center"><b>Order Amount</b></td>
		      <td width="10%" height="37" align="center"><b>Quantity</b></td>
		      <td width="10%" height="37" align="center"><b>Book Title</b></td>


          </tr>
 	
          <s:iterator value="orderItems" id="o">
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor='#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
		  <td align="center" ><s:property value="#o.orderItemId" /></td>
		  <td align="center" ><s:property value="#o.price" /></td>
		  <td align="center" ><s:property value="#o.quantity" /></td>
		  <td align="center" ><s:property value="#o.order.totalAmount" /></td>
		   <td align="center" ><s:property value="#o.order.quantity" /></td>
		  <td align="center" ><s:property value="#o.book.title" /></td>
