...
<div align="center" id="header">
  ...
  <b>Add Account</b>
    <form method="post" action="account.action">
    	 Shipping Address:<input type="text" name="account.shippingAddress"><br>
    	 Payment Method: <input type="text" name="account.paymentMethod"><br>
    	 Balance:<input type="text" name="account.balance"><br>
